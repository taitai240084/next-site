...
For an example, [check out this website](https://out-khozebgbnl.now.sh/) deployed statically to <PlatformLink />. The websites [source code](https://github.com/zeit/next.js/tree/canary/examples/basic-css) is available too.
